...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        var closeButton = document.querySelector(".popup-overlay .popup-close");

        closeButton.addEventListener("click", function() {
            var parent = this.closest(".popup-overlay");
 ...
 */
function contact_btn_code() {

	// Code du bouton
	$string .= '<button id"contact-btn-header"><a href="/contact" class="contact-btn">Nous contacter</a></button>';
